...
class Bandit(Unit):
    ...
    def check_crossbow_hit(self, result, turn, witcher, history, message):
        self.attack_speed = 1
    ...
    def check_cry(self, turn, history, message):
        self.crying = False
    ...
    def next_action(self, result, damage, turn, witcher, history, enemies, message):
        self.crying = False
        self.attack_speed = 1
        self.check_crossbow_hit(result, turn, witcher, history, message)
        self.dodge = False
        self.check_dodge(result, turn, witcher, history, message)
        if result != PlayerAction.dodge and result != PlayerAction.kven and result != PlayerAction.axiy:
            self.check_cry(turn, history, message)
...
class Ghost(Unit):
    ...
    def check_astral(self, result, witcher, turn, history, message):
        self.in_astral = False
    ...
    def next_action(self, result, damage, turn, witcher, history, enemies, message):
        self.check_astral(result, witcher, turn, history, message)
        k = 1.0
